...
class ProxyRequest(Base):
    ...
    client_request_headers: Mapped[JsonObject | None] = mapped_column(JSONB, nullable=True)
    ...
    client_request_body_raw: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    client_response_headers: Mapped[JsonObject | None] = mapped_column(JSONB, nullable=True)
